...
const loginUser = async (req, res) => {
  ...
  // 1. Cookie: 'lax'
  res.cookie("A-lax", "lax  httpOnly: false secure: true", {
    httpOnly: false,
    secure: true,
    maxAge: 3600000, // 1 hour
    sameSite: "lax",
  ...
  // 3. Cookie: 'empty-1.2'
  res.cookie("A-empty-1.2", "without path  httpOnly: false secure: true", {
    httpOnly: false,
    secure: true,
    maxAge: 3600000, // 1 hour
  ...
  // 4. Cookie: 'strict'
  res.cookie("A-strict", " httpOnly: false secure: true", {
    httpOnly: false,
    secure: true,
    maxAge: 3600000, // 1 hour
    sameSite: "strict",
  ...
  // 5. Cookie: 'lax-2'
  res.cookie("A-lax-2", "lax  httpOnly: true secure: false", {
    httpOnly: true,
    secure: false,
    maxAge: 3600000, // 1 hour
    sameSite: "lax",
  ...
  // 6. Cookie: 'strict-2'
  res.cookie("A-strict-2", " httpOnly: true secure: false", {
    httpOnly: true,
    secure: false,
    maxAge: 3600000, // 1 hour
    sameSite: "strict",
